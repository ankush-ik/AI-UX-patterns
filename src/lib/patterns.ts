      ...
      relatedPatterns: [
        {
          id: "initial-cta",
          title: "Initial CTA",
          description: "Make it frictionless to get started by including galleries near the initial CTA to help users avoid feeling intimidated by the blank canvas",
        },
        {
          id: "templates",
          title: "Templates",
          description: "When galleries contain examples of repeatable work, allow users to leverage examples as templates so they can produce something similar on their own",
        },
        {
          id: "prompt-details",
          title: "Prompt Details",
          description: "To make the gallery more educational, use prompt transparency to reveal the prompt behind the example generation",
        },
        {
          id: "suggestions",
          title: "Suggestions",
          description: "Use suggestions alongside galleries to provide inline generation without requiring browsing",
        },
        {
          id: "preset-styles",
          title: "Preset Styles",
          description: "Just as example galleries help users unblock their initiation creation, style pre-sets get users started with customizing their generations through parameters and references",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          ...
          description: "Use follow ups prior to generation. To confirm whether the prompt produces the intended result, use sample responses to verify the first few runs before running multiple generations.",
        },
        {
          id: "memory",
          title: "Memory",
          description: "As the AI gets to know the user by building its memory, use more personal followups that match the user's needs and context.",
        },
        {
          id: "action-plan",
          title: "Action Plan",
          description: "Group related or sequential follow ups into a plan of action to break large responses into smaller generations transparently and with the user's oversight.",
        },
      ],
      examples: [],
    },
      ...
      relatedPatterns: [
        {
          id: "example-gallery",
          title: "Example Gallery",
          description: "Surface a gallery of examples near the Initial CTA so users can preview possibilities and borrow inspiration before committing to their first prompt. This helps reduce the blank-page problem and builds confidence in what the system can do.",
        },
        {
          id: "filters",
          title: "Filters",
          description: "Introduce mode selectors near the CTA so users can scale between quick answers and deeper reasoning without switching contexts.",
        },
        {
          id: "attachments",
          title: "Attachments",
          description: "Allow users to drag files or links into the CTA so the system starts with richer context and reduces iteration loops.",
        },
        {
          id: "templates",
          title: "Templates",
          description: "Combine templates with the text box to guide structured tasks so the Initial CTA can serve both freeform and workflow-driven entry.",
        },
        {
          id: "suggestions",
          title: "Suggestions",
          description: "Pair Initial CTA with suggestions that give users easy entry points into the system so they are never left with a blank page.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "suggestions",
          title: "Suggestions",
          description: "Nudges are not only relevant at the start of an interaction. Suggestions are another example of how this pattern acts as a wayfinder to help users explore and go deeper with AI after their initial prompt has processed.",
        },
        {
          id: "modes",
          title: "Modes",
          description: "Consider which nudges to show for different modes. In research mode, a user might be prompted to upload a paper to explore. In chat mode, the nudge might be more casual and conversational.",
        },
        {
          id: "inline-action",
          title: "Inline Action",
          description: "Inline actions are common nudges, shown when users interact with their own content or generate something new. When contextual and timely, these help users understand the power of the system.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "example-gallery",
          title: "Example Gallery",
          description: "Prompt details are an important component of an example gallery as it helps users act on work that inspires them by easily generating new work based on the prompt or parameter in the reference.",
        },
        {
          id: "restructure",
          title: "Restructure",
          description: "Let users remix prompts, parameters, and references discovered by the user through galleries and other sources to engage deeper and find new creative paths to explore.",
        },
        {
          id: "describe",
          title: "Describe",
          description: "Showing prompt details by default helps users understand and get inspired by how generative content was constructed from its core parts. Extend this capability by supporting a define function that can be used on demand.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "prompt-details",
          title: "Prompt Details",
          description: "Another productive tool to get users started with a low bar is a style gallery with visible prompts. Users can find something that inspires them and use that prompt to kickstart their experience.",
        },
        {
          id: "templates",
          title: "Templates",
          description: "When users need reliable starting points with higher quality, switch to templates. Use the randomizer to warm up, then guide them into templates once they find a direction.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "inline-action",
          title: "Inline Action",
          description: "Suggestions are helpful if the user wishes to continue in a linear flow of iteration, but inline actions can proactively suggest divergent exploration and new branches for discovery.",
        },
        {
          id: "follow-up",
          title: "Follow Up",
          description: "When targeting suggestions based on the user's previous prompt or the context of the interaction thus far, position suggestions as follow ups. This encourages the user to share their intent, needs, and references up front for the AI to work with.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "madlibs",
          title: "Madlibs",
          description: "Though madlibs are most commonly seen in workflows, they represent a more generally easy way to build prompts when variables and references can be inferred from simple information.",
        },
        {
          id: "example-gallery",
          title: "Example Gallery",
          description: "Share templates in a gallery for users to select from based on their intended goals. This offers an opportunity to offer onboarding up front and maximize the context AI has about them going in.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "verification",
          title: "Verification",
          description: "For large fills, or when there is a risk of over-writing data, have users verify the result before filling the rest.",
        },
        {
          id: "chained-action",
          title: "Chained action",
          description: "To pair with variables and logic, include auto-fill as a step in a workflow.",
        },
        {
          id: "sample-response",
          title: "Sample response",
          description: "To save time and compute costs, preview with sample results when initially applying the prompt to ensure users get an expected result before generating the rest.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "sample-response",
          title: "Sample response",
          description: "Give users a method to test a single step or a full flow and generate a sample step that the user can verify before publishing or using the flow for live work.",
        },
        {
          id: "transform",
          title: "Transform",
          description: "Workflows can make it easy to transform content for different purposes as a background services, like converting audio recordings to text transcripts, creating summaries of videos, or generating presentations of reports.",
        },
        {
          id: "verification",
          title: "Verification",
          description: "Add steps to the workflow to have users verify information or actions before continuing. Verifications can be pushed to different devices or different services for ease of access.",
        },
        {
          id: "madlibs",
          title: "Madlibs",
          description: "Uses Madlibs steps in workflows so people can leverage your workflow by manually or automatically updating a few fields or variables for consistent and repeatable outcomes.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          ...
          description: "Iterating through text versions of prompts can give users more visibility and control over rich media generations. Make the describe action and the prompt enhancement action easy to find and use so users can use them together to refine their input.",
        },
        {
          id: "prompt-details",
          title: "Prompt details",
          description: "Don't make users search for prompt details. In galleries, personal histories, or direct links, share the prompt and relevant details upfront instead of relying on the describe function.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "variations",
          title: "Variations",
          description: "To work iteratively with the user, offer variations for each expand action so they can choose to regenerate or pick a specific new branch to follow.",
        },
        {
          id: "draft-mode",
          title: "Draft mode",
          description: "The initial seed for an expand action can be structured as a rough draft, giving just enough information to the AI to develop a fuller version of the user's intent.",
        },
        {
          id: "open-input",
          title: "Open input",
          description: "To allow users full control over their iterations, pair with an open text input to let them edit the original prompt.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "transform",
          title: "Transform",
          description: "Give prominence to common transformational actions, such as expand, shorten, or remix.",
        },
        {
          id: "footprints",
          title: "Footprints",
          description: "Maintain accountability in collaborative workflows by showing footprints of inline modifications so others can distinguish AI-assisted changes from human edits.",
        },
        {
          id: "verification",
          title: "Verification",
          description: "Give users confidence that inline edits improve quality by allowing them to verify the AI's changes before accepting them into the final output.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "watermark",
          title: "Watermark",
          description: "When human-created content is modified using AI, add a watermark to alert downstream consumers of the synthetic contribution.",
        },
        {
          id: "inline-action",
          title: "Inline Action",
          description: "Make inpainting controls easy to find with inline actions that appear when content is highlighted or selected.",
        },
        {
          id: "verification",
          title: "Verification",
          description: "Give users the ability to explore different directions while maintaining full control by allowing them to verify the AI's work before incorporating its changes into the original compositions.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "chained-action",
          title: "Chained action",
          description: "Build madlibs steps into workflows to carry variables forward between tasks or run complex processes off of a few variables submitted by users or pulled from context.",
        },
        {
          id: "templates",
          title: "Templates",
          description: "Create reusable structures for tasks by embedding templates with Madlibs inputs so users can generate consistent outputs on demand.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "controls",
          title: "Controls",
          description: "The interaction experience doesn't end when the user hits submit. Keep controls close to allow users to stop, pause, or edit their direct input once submitted.",
        },
        {
          id: "inline-action",
          title: "Inline Action",
          description: "When trying to adjust a specific span without crafting a full prompt, use inline actions. These appear on selection and keep scope tight. Pair them with open input so users can jump from presets to free-form when needed.",
        },
        {
          id: "parameters",
          title: "Parameters",
          description: "Use parameter controls to let users refine their prompt from the source. Open-ended defaults are helpful to get started, but more precise controls such as prompt or style intensity give them the most control.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "draft-mode",
          title: "Draft mode",
          description: "Use draft modes if the context allows for it, where users can work with fewer tokens or a less powerful model to get close to their final version before ramping up to more details or more compute power.",
        },
        {
          id: "variations",
          title: "Variations",
          description: "Whether overwriting or branching off of the first generation, support variations so users can review and compare generations and avoid losing work they preferred in an earlier iteration.",
        },
        {
          id: "randomize",
          title: "Randomize",
          description: "When the purpose of regeneration is to show the capabilities of the system or unblock creativity without intentional guidance from the user, use the randomize action.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "inpainting",
          title: "Inpainting",
          description: "Allow users to target restructured content to specific areas, such as adjusting filler words for individual speakers or converting different sections of an outline into written content to edit and review bit-by-bit.",
        },
        {
          id: "variations",
          title: "Variations",
          description: "Restructuring a piece of content can lead to unexpected results. Use variations or branching to create a new version for the user to compare, but allow them to return to the original version.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "memory",
          title: "Memory",
          description: "Restyle is often a one-off, but Memory makes choices stick. Carrying forward a preferred tone, palette, or voice across sessions reduces repetition and builds consistency. This also gives teams confidence that once a style is chosen, it won't have to be reapplied every time.",
        },
        {
          id: "preset-styles",
          title: "Preset styles",
          description: "Exploration is easier when people can see their options. A gallery of preset styles show examples of what the style looks like in application, so users don't have to imagine what \"playful\" or \"cinematic\" might mean.",
        },
        {
          id: "transform",
          title: "Transform",
          description: "Use transformation actions when the subtance and style of content is good but the modality itself needs to change, such as moving from an outline to a final version of a deck or video.",
        },
        {
          id: "restructure",
          title: "Restructure",
          description: "Use restructuing actions if the goal is to change the substance of content rather than its surface. Restyle alone will retain the content's details and only apply changes in aesthetic style or tone.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "references",
          title: "References",
          description: "Listing the references that compose the source material for the summary allows users to verify the summarized content and identity what content is most relevant to their query or needs.",
        },
        {
          id: "citations",
          title: "Citations",
          description: "While summaries provide an overall summary of a set of information, exposing the most pertinent points, citations provide paths back into the source of those points to help users drill into the source material more effectively and verify what was extracated.",
        },
        {
          id: "synthesis",
          title: "Synthesis",
          description: "Use the synthesis action when the goal is to integrate or interpret across multiple sources, not just condense them.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          ...
          description: "Show users the model's thought process across reasoning steps, tool calls, and key decisions to maintain traceability.",
        },
        {
          id: "citations",
          title: "Citations",
          description: "Citations help to maintain transparency and traceability in synthesized results by linking users to the sources behind interpretations and findings.",
        },
        {
          id: "summary",
          title: "Summary",
          description: "Use summary actions for faithful condensation of information, even across multiple sources, when no new interpretation is desired.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "branches",
          title: "Branches",
          description: "Encourage users to explore how the transform action will be interpreted by different models by supporting branching, along with clear descriptors of what each model excels in from the model selector.",
        },
        {
          id: "draft-mode",
          title: "Draft mode",
          description: "Use the transform action to create a draft version of more expensive processes before they run, like an outline for a slide deck, action plan for a site, or outilne for a movie.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "connectors",
          title: "Connectors",
          description: "Support connectors to allow users to connect attachments from their internal data sources without having to adjust sharing privacy at the document level.",
        },
        {
          id: "citations",
          title: "Citations",
          description: "Help users explore their source materials by providing citations to the source.",
        },
        {
          id: "describe",
          title: "Describe",
          description: "To help users understand which tokens will be pulled from the source, pair with token transparency.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "filters",
          title: "Filters",
          description: "Use filters to limit the model's attention to focus on information stored only in connectors (or, alternatively, only external sources) to give users control over where data is sourced from.",
        },
        {
          id: "references",
          title: "References",
          description: "Treat information stored in connectors as first-class sources by default when compiling reference lists, prioritizing stored internal knowledge over unverified, external information.",
        },
        {
          id: "citations",
          title: "Citations",
          description: "Use citations to deep link users to relevant internal context and documents, helping them verified summarized information and navigate their personal and institutional knowledge banks.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "attachments",
          title: "Attachments",
          description: "When you want users to rely on an explicit set of resources, include them as direct attachments.",
        },
        {
          id: "describe",
          title: "Describe",
          description: "To let users write more effective negative prompts, allow users to see a list of tokens currently being used in generation and their relative weights.",
        },
        {
          id: "references",
          title: "References",
          description: "To filters after the initial response, allow users to see and mange the list of references the AI relied on (web search, code files, etc) as a means of filtering for subsequent responses.",
        },
        {
          id: "modes",
          title: "Modes",
          description: "Adapt to task-specific needs by aligning with relevant filters, such as enabling \"scholarly-only\" in research mode or \"safe functions only\" in coding mode.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          ...
          description: "Show users the compute cost in tokens or real money between different models to help them budget their selection and deter using more powerful models for less powerful tasks.",
        },
        {
          id: "filters",
          title: "Filters",
          description: "To change the way the AI thinks and responds, define and use modes like research, study, build, or converse. Some modes may default to specific models.",
        },
        {
          id: "parameters",
          title: "Parameters",
          description: "Model selection can serve as a form of parameter, allowing the user to influence the AI's generation based styles specific to that model.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "model-management",
          title: "Model management",
          description: "Let users change the model when they need direct control over which engine runs the task (GPT-4, Claude, Gemini). Use modes when you want to abstract those differences into simple presets like \"research\" or \"creative.\"",
        },
        {
          id: "attachments",
          title: "Attachments",
          description: "Consider proactively suggesting modes based on the users' attachments to help them understand how they can be used with different types of media and inquiries.",
        },
        {
          id: "parameters",
          title: "Parameters",
          description: "Expose parameters alongside modes so advanced users can fine-tune how each mode operates, from reasoning depth to output length.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "memory",
          title: "Memory",
          description: "Parameters sometimes stick across sessions, which can surprise users if they expect a clean slate. If the AI \"remembers\" their last tone choice or autonomy setting, it should be obvious when that memory is in play and easy to reset.",
        },
        {
          id: "controls",
          title: "Controls",
          description: "Parameters shape how the AI runs a generation, but sometimes users need to act on the process itself. Controls let people stop a run that's going off track, pause and adjust, or rerun with changes, working work alongside parameters to keep the experience manageable and humans in charge.",
        },
        {
          id: "modes",
          title: "Modes",
          description: "Some changes controlled by parameters can be grouped into modes by default, making it easy to get run more powerful processed without having to adjust parameter weights every time.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "example-gallery",
          title: "Example gallery",
          description: "For marketplaces and user-generated galleries, show styles alongside other example galleries to encourage social sharing and incentivize engagement.",
        },
        {
          id: "parameters",
          title: "Parameters",
          description: "Provide parameters to allow users to adjust the temperator and details of the style after selected, or adjust how strongly the style should influence the final generation.",
        },
        {
          id: "saved-styles",
          title: "Saved styles",
          description: "Style presets offer a foundation from which users can explore how styles impact their generations, encouraging deeper engagement. Allow remixing from the preset gallery so users can start with a preset as a launchpad to create a style of their own.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "parameters",
          title: "Parameters",
          description: "Tune Parameters when you want to adjust temperature, length, or safety after the fact. Prompt enhancers operate on instruction quality up front, then parameters shape generation behavior.",
        },
        {
          id: "preset-styles",
          title: "Preset styles",
          description: "Use Preset styles to apply tone or visual language without rewriting task intent. An enhancer may add structure and constraints, then a style applies the aesthetic or voice on top.",
        },
      ],
      examples: [
        {
    ...
    content: {
      ...
      relatedPatterns: [
        ...
        },
        {
          id: "preset-styles",
          title: "Preset styles",
          description: "Many products come with pre-set styles to choose from. Saved styles are commonly added to these galleries with a filtered view for easy retrieval.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "saved-styles",
          title: "Saved styles",
          description: "To get users started, provide gallery of default styles to choose from. These act as starting points to explore different options, and act as a springboard to remix or clone when a user creates their own. Custom styles can be saved to the gallery by users or account managers for use on demand.",
        },
        {
          id: "model-management",
          title: "Model management",
          description: "Each model comes with a baseline style shaped by its training and prompts. Sometimes, switching models is the simplest way to change how outputs sound, look, or perform. The product should make this option easy to find. More advanced systems might route requests to different models in the background, but if you do this, surface what's happening so users know why tone is shifting.",
        },
        {
          id: "memory",
          title: "Memory",
          description: "Custom styles are strongest when paired with memory, storing how a user speaks, the depth of detail they expect, preferred terminology or generative parameters, and other recurring choices. With this continuity in place, the AI can apply a consistent style across modalities without requiring constant redefinition.",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "stream-of-thought",
          title: "Stream of Thought",
          description: "Show reasoning during execution",
        },
        {
          id: "verification",
          title: "Verification",
    ...
    content: {
      ...
      relatedPatterns: [
        ...
        },
        {
          id: "footprints",
          title: "Footprints",
          description: "Trace AI's process",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "stream-of-thought",
          title: "Stream of Thought",
          description: "See progress to inform control decisions",
        },
        {
          id: "cost-estimates",
          title: "Cost Estimates",
          description: "Understand impact of continuing",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "draft-mode",
          title: "Draft Mode",
          description: "Lower cost exploration",
        },
        {
          id: "model-management",
          title: "Model Management",
          description: "Choose cost vs capability",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "cost-estimates",
          title: "Cost Estimates",
          description: "Understand savings in draft mode",
        },
        {
          id: "sample-response",
          title: "Sample Response",
          description: "Preview before full generation",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          ...
          description: "Sessions without memory",
        },
        {
          id: "data-ownership",
          title: "Data Ownership",
          description: "Control data usage",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "citations",
          title: "Citations",
          description: "Inline source attribution",
        },
        {
          id: "attachments",
          title: "Attachments",
          description: "Provide specific references",
        },
      ],
      examples: [
        {
    ...
    content: {
      ...
      relatedPatterns: [
        ...
        },
        {
          id: "action-plan",
          title: "Action Plan",
          description: "Preview steps before execution",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "stream-of-thought",
          title: "Stream of Thought",
          description: "Show AI's reasoning",
        },
        {
          id: "controls",
          title: "Controls",
          description: "Manage AI execution",
        },
      ],
      examples: [
        {
    ...
    content: {
      ...
      relatedPatterns: [
        ...
        },
        {
          id: "footprints",
          title: "Footprints",
          description: "Trace after completion",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "regenerate",
          title: "Regenerate",
          description: "Single new version",
        },
        {
          id: "branches",
          title: "Branches",
          description: "Explore different paths",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "action-plan",
          title: "Action Plan",
          description: "Preview complex actions",
        },
        {
          id: "sample-response",
          title: "Sample Response",
      ...
      relatedPatterns: [
        {
          id: "data-ownership",
          title: "Data Ownership",
          description: "Control how data is used",
        },
        {
          id: "memory",
          title: "Memory",
          description: "Manage stored information",
        },
      ],
      examples: [
        {
    ...
    content: {
      ...
      relatedPatterns: [
        ...
        },
        {
          id: "incognito-mode",
          title: "Incognito Mode",
          description: "Prevent data storage",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "watermark",
          title: "Watermark",
          description: "Embedded AI content markers",
        },
        {
          id: "caveat",
          title: "Caveat",
          description: "Warn about limitations",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "stream-of-thought",
          title: "Stream of Thought",
          description: "Real-time reasoning display",
        },
        {
          id: "citations",
          title: "Citations",
      ...
      relatedPatterns: [
        {
          id: "disclosure",
          title: "Disclosure",
          description: "Visible AI content markers",
        },
        {
          id: "footprints",
          title: "Footprints",
          description: "Trace content origin",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "personality",
          title: "Personality",
          description: "AI character traits",
        },
        {
          id: "name",
          title: "Name",
          description: "How AI is referred to",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "color",
          title: "Color",
          description: "Visual AI indicators",
        },
        {
          id: "avatar",
          title: "Avatar",
          description: "AI visual identity",
        },
      ],
      examples: [
        {
      ...
      relatedPatterns: [
        {
          id: "personality",
          title: "Personality",
          description: "AI character and traits",
        },
        {
          id: "avatar",
          title: "Avatar",
